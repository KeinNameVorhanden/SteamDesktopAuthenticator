...
namespace Steam_Desktop_Authenticator
{
    public partial class SettingsForm : Form
    {
        ...
        private void ShowWarning(CheckBox affectedBox)
        {
            ...
            var result = MessageBox.Show("Warning: enabling this will severely reduce the security of your items! Use of this option is at your own risk. Would you like to continue?", "Warning!", MessageBoxButtons.YesNo);            if (result == DialogResult.No)
            {
